...
def pad_sequences2(sequences, max_len):
    padded_sequences = []
...
def calculate_amplitude_phase_matrix2(csv_original):
    ...
    for i, line in enumerate(csv_original):
        try:
            ...
            packet_amplitudes, packet_phases = calculate_raw_amplitudes_and_phases(line)
...
def process_all_csv_in_folder2(folder_path):
    ...
    for filename in os.listdir(folder_path):
        ...
        if filename.endswith(".csv") and not filename.endswith("_csi_data.csv"):
            heatmap_image, phase_matrix_sanitize = calculate_amplitude_phase_matrix2(file_path)
            ...
            process_all_csv_in_folder2(file_path)

if __name__ == "__main__":

    process_all_csv_in_folder2("/Users/sebastiandinu/Desktop/Tesi-Triennale/dataset_testing") # change with your dataset's path
    ...
    padded_data = pad_sequences2(all_phase_matrix, max_seq_len)
